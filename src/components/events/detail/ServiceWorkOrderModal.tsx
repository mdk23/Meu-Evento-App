...
import { EventServiceWithRelations, WorkOrderCustomFields } from './types';
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <h4 className="text-xs font-bold text-white flex items-center gap-1.5">
                <Users className="w-4 h-4 text-emerald-400" /> Assigned Staff
              </h4>
              <div className="flex gap-2">
                <select
            ...
            <div className="space-y-3">
              <h4 className="text-xs font-bold text-white flex items-center gap-1.5">
                <Package className="w-4 h-4 text-emerald-400" /> Reserved Inventory
              </h4>
              <div className="flex gap-2">
                <select
