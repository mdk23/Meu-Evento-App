...
import { Clock, DollarSign, CalendarDays, TrendingUp, ArrowRight, CheckCircle2, Users } from 'lucide-react';
...
/** The dashboard body shared by the unscoped cross-workspace "Business Overview" and the
 * Event-workspace-scoped "Overview" — same shape (`DashboardDTO`), the only difference is which
 * bookings the repository filtered by before this component ever sees the data. */
export default function EventOverviewDashboard({ data }: EventOverviewDashboardProps) {
    ...
    <div className="flex-1 overflow-y-auto page space-y-8">
      ...
      <div className="grid g4">
        ...
        <div className="card kpi plain f-in d3">
          ...
          <div className="val" style={{ color: 'var(--accent)' }}>{MT(kpis.netProfit)} MT</div>
      ...
      <div className="grid" style={{ gridTemplateColumns: '2fr 1fr', gap: 32 }}>
        ...
        <div className="space-y-6">
          ...
          <div className="card space-y-4" style={{ background: 'var(--accent-soft)' }}>
            ...
            <p className="mini">
              Staff, inventory and supplier records shared across every event.
            </p>
            <div className="pt-2">
